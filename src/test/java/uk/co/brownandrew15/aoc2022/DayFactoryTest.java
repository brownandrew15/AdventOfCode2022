...
public class DayFactoryTest {
    ...
    /**
     * Tests that a Day07 object is returned for day 7.
     */
    @Test
    public void testGetDay07() {
        try {
            Day day = DayFactory.getDay(7);
            assertEquals(day.getClass(), Day07.class);
        } catch (DayNotFoundException e) {
            fail(e.getMessage());
        }
    }
    ...
    /**
     * Tests that a Day08 object is returned for day 8.
     */
    @Test
    public void testGetDay08() {
        try {
            Day day = DayFactory.getDay(8);
            assertEquals(day.getClass(), Day08.class);
        } catch (DayNotFoundException e) {
            fail(e.getMessage());
        }
    }
    ...
    /**
     * Tests that a Day09 object is returned for day 9.
     */
    @Test
    public void testGetDay09() {
        try {
            Day day = DayFactory.getDay(9);
            assertEquals(day.getClass(), Day09.class);
        } catch (DayNotFoundException e) {
            fail(e.getMessage());
        }
    }
